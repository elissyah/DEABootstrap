#Direct to where input data located and for create output
setwd("C:/Users/Skripsi")

data <- read.table("input dea -cpo.txt",header=TRUE)
...
#Now we can create table which will display columns of certain labels as below
n=ncol(x)
...
#These syntax below will print the output in text format
